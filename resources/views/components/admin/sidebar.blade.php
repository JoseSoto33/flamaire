<aside id="default-sidebar" 
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-primary-600">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('admin-paises') }}/" wire:navigate.hover class="flex items-center p-2 text-white rounded-lg hover:text-tertiary hover:bg-secondary-200 group">
                    <svg class="w-5 h-5 text-white transition duration-75 group-hover:text-tertiary hidden" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <span class="ms-3" x-show="sidebar">Países</span>
                </a>
            </li>
            <li>
