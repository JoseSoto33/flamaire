@props(['disabled' => false, 'type' => 'button', 'btn_type' => 'primary', 'size' => 'md'])
@switch($size)
    @case('xs')
...
@switch($btn_type)
    ...
    @case('secondary')
        @php $class .= "select-none rounded-lg bg-primary-600 text-center align-middle font-sans font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 hover:bg-primary-800 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block"; @endphp
        @break
